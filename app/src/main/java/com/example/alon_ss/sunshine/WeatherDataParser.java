...
/**
 * Created by alon_ss on 4/25/16.
 */
public class WeatherDataParser {

    private static final String LOG_TAG = WeatherDataParser.class.getSimpleName();

    static String DAY_LIST = "list";
    ...
    public static double getMaxTemperatureForDay(String weatherJsonStr, int dayIndex)
        ...
        JSONArray dayList = obj.getJSONArray(DAY_LIST);
        if (dayList.length() < dayIndex){
            return -1;
        }
        JSONObject day = dayList.getJSONObject(dayIndex);
        JSONObject tempData = day.getJSONObject(TEMP);
        double max = tempData.getDouble(MAX);
 ...
 */
     ...
     */
    public static String[] getWeatherDataFromJson(String forecastJsonStr, int numDays, boolean isCelsius)
            throws JSONException {
